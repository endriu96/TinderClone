...
import kotlinx.android.synthetic.main.activity_log_in_actitivity.*
...
class ProfileFragment : Fragment() {
    ...
    fun onApply() {
        if (nameET.text.toString().isNullOrEmpty() ||
            ...
            val preferredGender = if (radioMan2.isChecked) GENDER_MALE
            else GENDER_FEMALE
            ...
            userDatabase.child(DATA_GENDER_PREFFERENCE).setValue(preferredGender)
